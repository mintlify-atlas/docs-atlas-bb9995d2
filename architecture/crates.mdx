...
See [Configuration documentation](/api/config/trading) for API configuration details.
...
- [Strategy Development](/strategies/strategy-trait) - Build custom strategies
